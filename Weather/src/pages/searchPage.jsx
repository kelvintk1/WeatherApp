      ...
      <div className='relative flex justify-center items-center mt-15'>
        <LiquidGlassCard>
          <div className='flex flex-col lg:flex-row justify-center items-center gap-10 lg:gap-3'>
            <span>
              <input type='text' placeholder='Enter city name...' className='p-3 rounded-md w-full lg:w-100 border-2 font-bold text-2xl' />
            </span>
            <span className='flex items-center justify-center'>
                <Link to='/result'>
                    <GradientButton className='ml-2 w-35 h-15 rounded-2xl text-white font-bold text-2xl cursor-pointer flex justify-center items-center active:scale-110 transition-transform duration-300 ease-in-out'>
                        <img src={search} alt='search-icon' className='w-7'/>
                        <p>Search</p>
                    </GradientButton>
                </Link>
              <img src={location} alt='location-icon' className='w-13 absolute right-3 lg:relative lg:ml-10 bg-amber-50 rounded-4xl cursor-pointer active:scale-115 transition-transform duration-300 ease-in-out'/>
            </span>
          </div>
        </LiquidGlassCard>
      </div>
